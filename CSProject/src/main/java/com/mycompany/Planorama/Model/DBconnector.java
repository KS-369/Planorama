...
/* CONTROLLER CLASS
* DESCRIPTION: 
* - This class is the model for the MVC and manages the database for the event management system.
* INPUTS: 
* - Event information (title, date, description).
* OUTPUTS: 
* - Updates and changes the SQL database based on the user's actions (edit, update, delete).
