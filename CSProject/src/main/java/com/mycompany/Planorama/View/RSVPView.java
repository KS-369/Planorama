...
import com.mycompany.Planorama.View.ImagePanel;
...
import com.mycompany.Planorama.View.RSVPBut;
import com.mycompany.Planorama.View.toEventsManager;
import com.mycompany.Planorama.View.BackToRSVPBut;
...
public class RSVPView {
    ...
    public static void makeScreen(JFrame frame) {
        ...
        ImagePanel back = new ImagePanel("C:\\Users\\adupa\\OneDrive\\Documents\\NetBeansProjects\\CSProject\\src\\main\\java\\eventOptions.png", 0, 0, 1200, 700);
        ...
        ImagePanel firstRSVPPic = new ImagePanel("C:\\Users\\adupa\\OneDrive\\Documents\\NetBeansProjects\\CSProject\\src\\main\\java\\RSVPPic.png", 0, 0, 150, 50);
        ...
        ImagePanel secondRSVPPic = new ImagePanel("C:\\Users\\adupa\\OneDrive\\Documents\\NetBeansProjects\\CSProject\\src\\main\\java\\RSVPPic.png", 0, 0, 150, 50);
        ...
        ImagePanel thirdRSVPPic = new ImagePanel("C:\\Users\\adupa\\OneDrive\\Documents\\NetBeansProjects\\CSProject\\src\\main\\java\\RSVPPic.png", 0, 0, 150, 50);
    ...
    public static void RSVPScreen(JFrame frame, String eventName) {
        ...
        // setting background
        ImagePanel back = new ImagePanel("C:\\Users\\adupa\\OneDrive\\Documents\\NetBeansProjects\\CSProject\\src\\main\\java\\plainBack.png", 0, 0, 1200, 700);
        back.setBounds(0, 0, 1200, 700);
        ...
        // user name
        JLabel nameLabel = new JLabel("Name: " + LoginUI.getUsername());
        ...
        //adding a back button to the page to navigate back to the home page
        JButton BackRSVPBut = new JButton("Back");
        BackRSVPBut.setBounds(600,400,100,30);
        BackRSVPBut.addActionListener(new BackToRSVPBut(frame));
        ...
        layeredPane.add(BackRSVPBut, Integer.valueOf(5));
