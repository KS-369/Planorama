...
public class finalizeRSVP implements ActionListener {
    ...
    JFrame frame;
    String comment;
    public static DBConnector_1 dbConnector = new DBConnector_1("jdbc:sqlite:C:/Users/adupa/OneDrive/Documents/NetBeansProjects/CSProject/src/main/java/com/mycompany/Planorama_HomePage/Model2/rsvp.db");
