...
//        DBconnector db = new DBconnector("events.db"); //DBconnector instance
//        EventManagementUI ui = new EventManagementUI(null); 
//        Controller controller = new Controller(db,ui); //creating a new instance of Connector
//        ui.setController(controller); //setting the controller (in the Event Management UI class) to ui and db.
