...
class ImagePanel extends JPanel {
    ...
    public ImagePanel(String imagePath, int theX, int theY, int theWidth, int theHeight) {

        this.height = theHeight;
        this.width = theWidth;
        this.X = theX;
        this.Y = theY;
        this.thePath = imagePath;
...
//HomPageUI class contains key methods relating to the creation of the GUI, including the home page creator method and the page refresher method (that removes previous screen elements)
public class HomePageUI {
    ...
    public static void homeScreen(JFrame frame) {
        ...
        DBConnector.createTableIfNotExists(); //if the table doesn't exist, one is created to prevent program from crashing
    ...
    public static void sidePannel(JLayeredPane layeredPane, JFrame frame){
        ...
        aboutUsBut.addActionListener(new toAboutUs(currentUser));
