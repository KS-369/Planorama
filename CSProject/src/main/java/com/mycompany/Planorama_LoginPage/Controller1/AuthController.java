 ...
 */
package com.mycompany.Planorama_LoginPage.Controller1;
...
import com.mycompany.Planorama_LoginPage.Model1.*;
import com.mycompany.Planorama_LoginPage.View1.*;
    ...
    public AuthController(UserModel model, LoginUI view) {
        ...
        view.loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //Changes the login page to home page.
                if (model.authenticate(username, password)) {
                    view.dispose(); // Close login window
                    HomePageUI.currentUser = username; // Set global user state
                    JFrame homeFrame = new JFrame();
                    homeFrame.setSize(1200, 700);
                    homeFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                    HomePageUI.homeScreen(homeFrame);
