 ...
 */
package com.mycompany.Planorama_LoginPage.Model1;
...
public class UserModel {
    ...
    public UserModel() {
        try {
            conn = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\adupa\\OneDrive\\Documents\\NetBeansProjects\\CSProject\\src\\main\\java\\com\\mycompany\\Planorama_LoginPage\\Model1\\users.db"); // change this to create db file in different file path
            createTable();
