...
public class MainPageUI {
    ...
    ImagePanel back = new ImagePanel("/home/Kalli-Ann/NetBeansProjects/Planorama-main/Planorama (Users)/src/main/java/Planorama.png", 0, 0, 1200, 700);
    back.setBounds(0,0,1200,700);
    

    
//    ImagePanel loginLogoutPic = new ImagePanel("/home/Kalli-Ann/NetBeansProjects/Planorama-main/Planorama (Users)/src/main/java/LoginLogout.png", 0, 0, 150, 50);
...
//    
//    // new code - fix
//    loginLogoutBut.addActionListener(new ActionListener() {
//        @Override
...
//                frame.dispose();
//            } else {
//                JOptionPane.showMessageDialog(frame, "You are already logged in as " + currentUser + ".");
//            }
//        }
//    });

    
    ImagePanel yourEventsPic = new ImagePanel("/home/Kalli-Ann/NetBeansProjects/Planorama-main/Planorama (Users)/src/main/java/yourevents.png", 0, 0, 150, 50);
    ...
    ImagePanel eventsNearYouPic = new ImagePanel("/home/Kalli-Ann/NetBeansProjects/Planorama-main/Planorama (Users)/src/main/java/eventsnearu.png", 0, 0, 150, 50);
    ...
    ImagePanel createEventPic = new ImagePanel("/home/Kalli-Ann/NetBeansProjects/Planorama-main/Planorama (Users)/src/main/java/createEvent.png", 0, 0, 150, 50);
    ...
    ImagePanel aboutUsPic = new ImagePanel("/home/Kalli-Ann/NetBeansProjects/Planorama-main/Planorama (Users)/src/main/java/aboutUs.png", 0, 0, 150, 50);
...
//    ImagePanel mainPic = new ImagePanel("/home/Kalli-Ann/NetBeansProjects/Planorama-main/Planorama (Users)/src/main/java/1-a3992788.png", 0, 0, 200, 200);
...
//    layeredPane.add(loginLogoutBut, Integer.valueOf(2));
    ...
    layeredPane.add(aboutUsPic, Integer.valueOf(9));
    layeredPane.add(aboutUsBut, Integer.valueOf(10));
//    layeredPane.add(mainPic, Integer.valueOf(11));
